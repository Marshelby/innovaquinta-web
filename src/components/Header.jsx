...
export default function Header() {
  return (
    <header data-aos="fade-down" className="flex flex-col items-center justify-center py-12 bg-gradient-to-br from-cyan-700 via-cyan-600 to-sky-500 text-white shadow-lg">
